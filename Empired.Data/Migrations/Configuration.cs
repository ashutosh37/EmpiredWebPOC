namespace Empired.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EmpiredWebContext>
    {
        ...
        protected override void Seed(EmpiredWebContext context)
        {
            //  create genres
            ...
            // create customers
            context.PatientSet.AddOrUpdate(GenerateCustomers());
        ...
        private Patient[] GenerateCustomers()
        {
            List<Patient> _customers = new List<Patient>();
